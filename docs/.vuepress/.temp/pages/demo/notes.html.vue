<template><div><h1 id="安装项目" tabindex="-1"><a class="header-anchor" href="#安装项目" aria-hidden="true">#</a> 安装项目</h1>
<figure><img src="@source/demo/imgs/notes/image-20230320173330881.png" alt="image-20230320173330881" tabindex="0" loading="lazy"><figcaption>image-20230320173330881</figcaption></figure>
<h2 id="test" tabindex="-1"><a class="header-anchor" href="#test" aria-hidden="true">#</a> test</h2>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">com<span class="token punctuation">.</span>hhyy</span><span class="token punctuation">;</span>
